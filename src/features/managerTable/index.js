...
const TopSideButtons = () => {
    ...
    const openAddNewLeadModal = () => {
        dispatch(openModal({title : "Add New Manager", bodyType : MODAL_BODY_TYPES.LEAD_ADD_NEW}))
    }
...
function Leads(){
    ...
    const deleteCurrentLead = (index) => {
        ...
        extraObject : { message : `Are you sure you want to delete this Manager?`, type : CONFIRMATION_MODAL_CLOSE_TYPES.LEAD_DELETE, index}}))
    }
