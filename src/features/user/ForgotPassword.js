                ...
                <div className='py-24 px-10'>
...

                    {
                        ...
                        <>
                            ...
                            <div className=' text-center mt-4'><Link to="/login"><button className="bg-logo-color-dark-green btn btn-block ">Login</button></Link></div>
...

                    {
                        ...
                        <>
                            ...
                            <form onSubmit={(e) => submitForm(e)}>
                                ...
                                <button type="submit" className={"bg-logo-color-dark-green btn mt-2 w-full" + (loading ? " loading" : "")}>Send Reset Link</button>

                                <div className=' text-center mt-4'>Don't have an account yet? <Link to="/register"><button className=" text-blue inline-block  hover:text-primary hover:underline hover:cursor-pointer transition duration-200">Register</button></Link></div>
                            </form>
                        </>
                    }
